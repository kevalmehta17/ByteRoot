...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:scale-105 hover:shadow-lg",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 dark:hover:shadow-glow-primary-dark hover:shadow-glow-primary-light",
        destructive:
        ...
        ghost:
          "hover:bg-accent hover:text-accent-foreground hover:shadow-none hover:scale-100", // Ghost usually doesn't scale or shadow
        link: "text-primary underline-offset-4 hover:underline hover:shadow-none hover:scale-100", // Link usually doesn't scale or shadow
      },
      size: {
